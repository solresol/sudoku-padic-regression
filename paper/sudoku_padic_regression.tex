...
\midrule
finite-domain all-different system & Finite-domain constraint system in which every designated scope must take pairwise distinct values & Section~\ref{sec:introduction} \\
...
\parbox[t]{\linewidth}{\raggedright positive complement\\expansion} & Replacement, on a finite residual range, of a negative reward for avoiding a forbidden equality by positive terms for the allowed equalities, up to an additive constant & Appendix~\ref{sec:mihara-digitwise} \\
