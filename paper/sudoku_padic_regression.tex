...
\parbox[t]{\linewidth}{\raggedright positive complement\\expansion} & Rewriting of a negative reward row as positive wells at the allowed residual values; equal up to an additive constant on the finite domain & Section~\ref{sec:mihara-digitwise} \\
