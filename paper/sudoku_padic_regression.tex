...
We implemented two simple local-search procedures: a greedy row-swap search and a discrete Zubarev walk. Appendix~\ref{app:heuristics} defines their loss, records the algorithms and a locality lemma for row swaps, and gives traces on a standard puzzle.
