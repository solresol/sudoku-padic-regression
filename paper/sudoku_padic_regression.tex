...
The eight observations have two equivalent presentations: Table \ref{tab:list-colouring-dataframe} and Figure~\ref{fig:list-colouring-regression} which uses a compact tuple notation, in which each tuple \((\sigma,u,b,\gamma)\) has signed weight \(w=\sigma\gamma\).
